  ...
  <div>
    <div class="u-grid-wrapper">
	  ...
	  <FoodStorageDetail
	        ...
	        :food-item="selectedItem"
	        @close="handleClose"
	      ></FoodStorageDetail>
		<ShoppingCartPopup
			  :visible.sync="cartPopupVisible"
...
AddFoodItemPopup
  ...
  data() {
	...
	detailVisible: false,
	shoppingLists: [
		{id: 1, name: "购物清单1",foods:[]},
		{id: 2, name: "购物清单2",foods:[]},
		{id: 3, name: "购物清单3",foods:[]},
	], // 购物清单数据
  ...
  methods: {
	...
	handleAddItem(newItem) {
		  ...
		  const newFoodItem = { ...newItem, id: this.getNextId() };
